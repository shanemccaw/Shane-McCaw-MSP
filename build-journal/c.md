...
- **Status:** ⏳ MERGE-BLOCKED — code complete on branch `claude/session-limit-auto-restart-nngq59` (this web session was explicitly required to push there, not main); flip to ✅ DONE once Shane merges it
- **Scope:** buildconsole
- **Started:** 2026-08-28
