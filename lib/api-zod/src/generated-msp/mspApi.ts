...
export const MspAuthLoginResponse = zod.object({
  ...
  "mspRole": zod.enum(['PlatformAdmin', 'MSPAdmin', 'MSPOperator', 'Customer', 'RetainerConsented', 'RetainerPending', 'PackConsented', 'PackPending', 'MonitoringConsented', 'MonitoringPending', 'ServiceAccount', 'Free']).nullish(),
