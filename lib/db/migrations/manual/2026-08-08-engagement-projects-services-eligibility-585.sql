...
VALUES
  ...
  ('pim-rollout-eligibility', 'PIM Rollout - Eligibility',
   ...
   '["signal.identity.pim-permanent-roles","signal.identity.global-admin-count"]'::jsonb, 'OR', 0, true, 13),
  ('pim-rollout-scoring', 'PIM Rollout - Scoring',
   ...
   '["signal.identity.pim-permanent-roles","signal.identity.global-admin-count"]'::jsonb, 'OR', 60, true, 14),
  ...
  ('email-security-hardening-eligibility', 'Email Security Hardening - Eligibility',
   ...
   '["signal.exchange.dkim-spf-dmarc-status","signal.exchange.antispam-policy-coverage"]'::jsonb, 'OR', 0, true, 15),
  ('email-security-hardening-scoring', 'Email Security Hardening - Scoring',
   ...
   '["signal.exchange.dkim-spf-dmarc-status","signal.exchange.antispam-policy-coverage"]'::jsonb, 'OR', 60, true, 16),
  ...
  ('zero-trust-architecture-eligibility', 'Zero Trust Architecture Implementation - Eligibility',
   ...
   '["signal.identity.ca-mfa-coverage","signal.identity.ca-device-compliance","signal.devices.compliance-policy-coverage"]'::jsonb, 'OR', 0, true, 17),
  ('zero-trust-architecture-scoring', 'Zero Trust Architecture Implementation - Scoring',
   ...
   '["signal.identity.ca-mfa-coverage","signal.identity.ca-device-compliance","signal.devices.compliance-policy-coverage"]'::jsonb, 'OR', 60, true, 18),
  ...
  ('governance-remediation-hardening-eligibility', 'Governance Remediation & Architecture Hardening - Eligibility',
   ...
   '["signal.governance.ownerless-groups","signal.governance.overdue-access-reviews"]'::jsonb, 'OR', 0, true, 19),
  ('governance-remediation-hardening-scoring', 'Governance Remediation & Architecture Hardening - Scoring',
   ...
   '["signal.governance.ownerless-groups","signal.governance.overdue-access-reviews"]'::jsonb, 'OR', 60, true, 20),
  ...
  ('data-classification-label-rollout-eligibility', 'Data Classification & Sensitivity Label Rollout - Eligibility',
   ...
   '["signal.governance.sensitivity-label-adoption","signal.governance.auto-labeling-coverage"]'::jsonb, 'OR', 0, true, 21),
  ('data-classification-label-rollout-scoring', 'Data Classification & Sensitivity Label Rollout - Scoring',
   ...
   '["signal.governance.sensitivity-label-adoption","signal.governance.auto-labeling-coverage"]'::jsonb, 'OR', 60, true, 22),
  ...
  ('retention-records-management-eligibility', 'Retention & Records Management Implementation - Eligibility',
   ...
   '["signal.governance.retention-policy-coverage","signal.governance.retention-label-adoption"]'::jsonb, 'OR', 0, true, 23),
  ('retention-records-management-scoring', 'Retention & Records Management Implementation - Scoring',
   ...
   '["signal.governance.retention-policy-coverage","signal.governance.retention-label-adoption"]'::jsonb, 'OR', 60, true, 24),
  ...
  ('compliance-framework-implementation-eligibility', 'Compliance Framework Implementation - Eligibility',
   ...
   '["signal.governance.retention-policy-coverage","signal.security.secure-score"]'::jsonb, 'OR', 0, true, 25),
  ('compliance-framework-implementation-scoring', 'Compliance Framework Implementation - Scoring',
   ...
   '["signal.governance.retention-policy-coverage","signal.security.secure-score"]'::jsonb, 'OR', 60, true, 26),
  ...
  ('sharepoint-teams-ia-rebuild-eligibility', 'SharePoint & Teams Information Architecture Rebuild - Eligibility',
   ...
   '["signal.sharepoint.inactive-sites","signal.teams.ownerless-teams"]'::jsonb, 'OR', 0, true, 27),
  ('sharepoint-teams-ia-rebuild-scoring', 'SharePoint & Teams Information Architecture Rebuild - Scoring',
   ...
   '["signal.sharepoint.inactive-sites","signal.teams.ownerless-teams"]'::jsonb, 'OR', 60, true, 28),
  ...
  ('exchange-online-hygiene-eligibility', 'Exchange Online Hygiene & Modernization - Eligibility',
   ...
   '["signal.exchange.transport-rule-count","signal.exchange.mail-flow-rule-review"]'::jsonb, 'OR', 0, true, 29),
  ('exchange-online-hygiene-scoring', 'Exchange Online Hygiene & Modernization - Scoring',
   ...
   '["signal.exchange.transport-rule-count","signal.exchange.mail-flow-rule-review"]'::jsonb, 'OR', 60, true, 30),
  ...
  ('copilot-m365-deployment-eligibility', 'Copilot for Microsoft 365 Deployment Project - Eligibility',
   ...
   '["signal.copilot.readiness-prerequisite","signal.copilot.license-vs-total-users"]'::jsonb, 'OR', 0, true, 31),
  ('copilot-m365-deployment-scoring', 'Copilot for Microsoft 365 Deployment Project - Scoring',
   ...
   '["signal.copilot.readiness-prerequisite","signal.copilot.license-vs-total-users"]'::jsonb, 'OR', 60, true, 32),
  ...
  ('copilot-adoption-governance-eligibility', 'Copilot Adoption & Governance Program - Eligibility',
   ...
   '["signal.copilot.active-usage-rate"]'::jsonb, 'OR', 0, true, 33),
  ('copilot-adoption-governance-scoring', 'Copilot Adoption & Governance Program - Scoring',
   ...
   '["signal.copilot.active-usage-rate"]'::jsonb, 'OR', 60, true, 34),
  ...
  ('bcdr-implementation-eligibility', 'Business Continuity / Disaster Recovery Implementation - Eligibility',
   ...
   '["signal.exchange.litigation-hold-coverage"]'::jsonb, 'OR', 0, true, 35),
  ('bcdr-implementation-scoring', 'Business Continuity / Disaster Recovery Implementation - Scoring',
   ...
   '["signal.exchange.litigation-hold-coverage"]'::jsonb, 'OR', 60, true, 36),
  ...
  ('teams-phone-config-eligibility', 'Teams Phone License & Calling Policy Configuration - Eligibility',
   ...
   '["signal.teams.messaging-policy-coverage"]'::jsonb, 'OR', 0, true, 37),
  ('teams-phone-config-scoring', 'Teams Phone License & Calling Policy Configuration - Scoring',
   ...
   '["signal.teams.messaging-policy-coverage"]'::jsonb, 'OR', 60, true, 38),
  ...
  ('teams-rooms-config-eligibility', 'Teams Rooms License & Policy Configuration - Eligibility',
   ...
   '["signal.teams.rooms-device-health"]'::jsonb, 'OR', 0, true, 39),
  ('teams-rooms-config-scoring', 'Teams Rooms License & Policy Configuration - Scoring',
   ...
   '["signal.teams.rooms-device-health"]'::jsonb, 'OR', 60, true, 40)
