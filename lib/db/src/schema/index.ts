...
// and live in its own database (BUILD_DATABASE_URL, Git #3651). Their stale copies in
// this database were dropped by lib/db/migrations/manual/2026-09-11-drop-shared-bt-tables-3653.sql.
