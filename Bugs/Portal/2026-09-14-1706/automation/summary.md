...
> **Product**: `Portal`  
> **Session ID**: `2026-09-14-1706`  
> **Date**: 2026-09-14 17:06:56 – 17:07:41  
> **Duration**: 00m 45s (45.1s)  
> **Result**: ❌ 1 STEP FAILURE(S) (4/5 passed, 80.0%)  

## Executive Summary
❌ TEST ABORTED — critical step 7 (expect [data-testid='settings-page']) failed: [data-testid='settings-page'] — state 'visible' NOT matched (found=False, visible=False) [polled 30002ms / 120 attempts, 30000ms budget exhausted] (4/19 steps ran, 12 skipped)
...
|:---:|:---|:---|:---:|:---:|:---|
| 1 | `goto` | `/portal/login` | ✅ PASS | 822ms | Navigated to http://localhost:5175/portal/login |
...
| 6 | `goto` | `/portal/settings` | ✅ PASS | 1051ms | Navigated to http://localhost:5175/portal/settings |
...
Run aborted: critical step 7 (expect [data-testid='settings-page']) failed: [data-testid='settings-page'] — state 'visible' NOT matched (found=False, visible=False) [polled 30002ms / 120 attempts, 30000ms budget exhausted]. Check prerequisite selectors, authentication, or network connectivity.
