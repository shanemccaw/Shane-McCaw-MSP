...
> **Product**: `Portal`  
> **Session ID**: `2026-09-16-2230`  
> **Date**: 2026-09-16 22:30:02 – 22:30:14  
> **Duration**: 00m 12s (12.5s)  
...
|:---:|:---|:---|:---:|:---:|:---|
| 1 | `goto` | `/portal/login` | ✅ PASS | 1070ms | Navigated to http://localhost:5175/portal/login |
| 2 | `expect` | `[data-testid='login-email']` | ✅ PASS | 20ms | [data-testid='login-email'] — state 'visible' matched (found=True, visible=True) |
| 3 | `input` | `[data-testid='login-email']` | ✅ PASS | 25ms | Executed input on [data-testid='login-email'] |
