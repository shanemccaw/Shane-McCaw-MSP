...
> **Product**: `Portal`  
> **Session ID**: `2026-09-16-2227`  
> **Date**: 2026-09-16 22:27:34 – 22:28:29  
> **Duration**: 00m 55s (55.4s)  
...
|:---:|:---|:---|:---:|:---:|:---|
| 1 | `goto` | `/portal/login` | ✅ PASS | 1570ms | Navigated to http://localhost:5175/portal/login |
| 2 | `expect` | `[data-testid='login-email']` | ✅ PASS | 38ms | [data-testid='login-email'] — state 'visible' matched (found=True, visible=True) |
| 3 | `input` | `[data-testid='login-email']` | ✅ PASS | 77ms | Executed input on [data-testid='login-email'] |
| 4 | `input` | `[data-testid='login-password']` | ✅ PASS | 31ms | Executed input on [data-testid='login-password'] |
| 5 | `click` | `[data-testid='login-submit']` | ✅ PASS | 31ms | Executed click on [data-testid='login-submit'] |
