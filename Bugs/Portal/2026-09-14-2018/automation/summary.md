...
> **Product**: `Portal`  
> **Session ID**: `2026-09-14-2018`  
> **Date**: 2026-09-14 20:18:21 – 20:18:28  
> **Duration**: 00m 07s (7.7s)  
...
|:---:|:---|:---|:---:|:---:|:---|
| 1 | `goto` | `/portal/security-plan` | ✅ PASS | 920ms | Navigated to http://localhost:5175/portal/security-plan |
| 2 | `expect` | `body` | ✅ PASS | 24ms | body — state 'visible' matched (found=True, visible=True); text contained "Si... |
