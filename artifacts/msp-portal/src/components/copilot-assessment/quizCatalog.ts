...
export const QUIZ_NAV_ITEMS = [
  { id: 'industry', label: 'Industry', stepNumber: 1, isMultiSelect: false },
  { id: 'clusters', label: 'Persona Clusters', stepNumber: 2, isMultiSelect: true },
  { id: 'personas', label: 'Personas', stepNumber: 3, isMultiSelect: true },
  { id: 'use-cases', label: 'Use Cases', stepNumber: 4, isMultiSelect: true },
  { id: 'sensitivity', label: 'Data Sensitivity', stepNumber: 5, isMultiSelect: true },
  { id: 'collaboration', label: 'Collaboration Pattern', stepNumber: 6, isMultiSelect: true },
  { id: 'ai-comfort', label: 'AI Comfort', stepNumber: 7, isMultiSelect: false },
  { id: 'workflow', label: 'Workflow Structure', stepNumber: 8, isMultiSelect: false },
  { id: 'adoption-speed', label: 'Adoption Speed', stepNumber: 9, isMultiSelect: false },
  { id: 'outcomes', label: 'Outcome Priorities', stepNumber: 10, isMultiSelect: true },
  { id: 'change-mgmt', label: 'Change Management', stepNumber: 11, isMultiSelect: false },
  { id: 'review', label: 'Review', stepNumber: 12, isMultiSelect: false },
];
