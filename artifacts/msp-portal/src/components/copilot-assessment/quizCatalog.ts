...
export const ADAPTIVE_DATA_SENSITIVITY: Record<string, QuizOptionTile[]> = {
  ...
  manufacturing: [
    { id: 'trade_secrets_mfg', title: 'Trade Secrets / Process IP', description: 'Proprietary process designs, formulas & CAD/PLM engineering data', iconName: 'Lock', badge: 'Restricted' },
    { id: 'scada_ot_mfg', title: 'SCADA / OT Telemetry', description: 'Industrial control system data, PLC configs & shop-floor machine telemetry', iconName: 'Activity' },
    { id: 'supplier_confidential_mfg', title: 'Supplier & Contract Data', description: 'Vendor pricing, sourcing NDAs & supply chain agreements', iconName: 'FileSpreadsheet' },
    { id: 'low_sens_mfg', title: 'Low Sensitivity', description: 'Product catalogs, public specifications & marketing materials', iconName: 'Globe' },
  ],
  education: [
    { id: 'ferpa_student', title: 'FERPA Student Records', description: 'Grades, transcripts, disciplinary records & IEP/504 documentation', iconName: 'GraduationCap', badge: 'FERPA' },
    { id: 'research_ip_edu', title: 'Research & Grant IP', description: 'Unpublished research data, grant proposals & patent-pending findings', iconName: 'Microscope' },
    { id: 'internal_admin_edu', title: 'Internal Administrative', description: 'Faculty HR records, budget planning & institutional governance docs', iconName: 'Building' },
    { id: 'low_public_edu', title: 'Low / Public', description: 'Course catalogs, public event info & published curricula', iconName: 'Globe' },
  ],
  government: [
    { id: 'classified_gov', title: 'Classified / National Security', description: 'Defense and intelligence classified material subject to strict clearance controls', iconName: 'Lock', badge: 'Classified' },
    { id: 'cui_gov', title: 'CUI / FOUO', description: 'Controlled unclassified information & for-official-use-only records', iconName: 'Shield' },
    { id: 'citizen_pii_gov', title: 'Citizen PII', description: 'Constituent records, benefits data & tax/identity information', iconName: 'EyeOff' },
    { id: 'public_records_gov', title: 'Public Records', description: 'FOIA-releasable documents, press materials & open meeting minutes', iconName: 'Globe' },
  ],
  legal: [
    { id: 'privilege_workproduct', title: 'Privileged / Work Product', description: 'Attorney-client privileged communications, litigation strategy & work product', iconName: 'Scale', badge: 'Privileged' },
    { id: 'client_confidential_legal', title: 'Client Confidential', description: 'Matter files, deal terms & client financial information', iconName: 'Lock' },
    { id: 'regulatory_filings_legal', title: 'Regulatory / Compliance Filings', description: 'Court filings, regulatory submissions & audit response records', iconName: 'FileCheck' },
    { id: 'low_sens_legal', title: 'Low Sensitivity', description: 'Public legal commentary, firm marketing & attorney bios', iconName: 'Globe' },
  ],
  retail: [
    { id: 'pci_cardholder', title: 'PCI / Cardholder Data', description: 'Payment card data, transaction records & point-of-sale logs', iconName: 'Lock', badge: 'PCI-DSS' },
    { id: 'customer_pii_retail', title: 'Customer PII', description: 'Loyalty program data, purchase history & customer contact information', iconName: 'EyeOff' },
    { id: 'vendor_pricing_retail', title: 'Vendor & Pricing Data', description: 'Supplier contracts, margin data & promotional strategy', iconName: 'Tag' },
    { id: 'low_public_retail', title: 'Low / Public', description: 'Product catalogs, store locations & marketing content', iconName: 'Globe' },
  ],
  technology: [
    { id: 'source_code_ip', title: 'Source Code / IP', description: 'Proprietary codebases, algorithms & unreleased feature designs', iconName: 'Code', badge: 'IP' },
    { id: 'customer_data_tech', title: 'Customer & Usage Data', description: 'Product telemetry, account data & usage analytics', iconName: 'BarChart2' },
    { id: 'infra_secrets_tech', title: 'Infra Secrets & Credentials', description: 'API keys, infrastructure configs & access credentials', iconName: 'Lock' },
    { id: 'low_public_tech', title: 'Low / Public', description: 'Public documentation, marketing content & open-source contributions', iconName: 'Globe' },
  ],
  energy: [
    { id: 'scada_ot_energy', title: 'SCADA / OT Data', description: 'Grid control systems, pipeline telemetry & plant control data', iconName: 'Activity', badge: 'Critical Infra' },
    { id: 'regulatory_energy', title: 'Regulatory / Environmental', description: 'Emissions data, permit filings & compliance audit records', iconName: 'ShieldCheck' },
    { id: 'commercial_energy', title: 'Commercial / Trading Data', description: 'Contract terms, hedging positions & pricing models', iconName: 'LineChart' },
    { id: 'low_public_energy', title: 'Low / Public', description: 'Public safety information & community outreach materials', iconName: 'Globe' },
  ],
  transportation: [
    { id: 'dot_hazmat', title: 'DOT / Hazmat Compliance', description: 'Hazardous materials manifests & safety inspection records', iconName: 'ShieldAlert', badge: 'DOT' },
    { id: 'fleet_telemetry', title: 'Fleet & Vehicle Telemetry', description: 'GPS tracking, maintenance logs & driver compliance data', iconName: 'Activity' },
    { id: 'customer_freight_data', title: 'Customer & Freight Data', description: 'Shipment details, billing records & contract rates', iconName: 'FileText' },
    { id: 'low_public_transport', title: 'Low / Public', description: 'Public schedules, route maps & marketing materials', iconName: 'Globe' },
  ],
  agriculture: [
    { id: 'proprietary_ag_data', title: 'Proprietary Yield & Research Data', description: 'Crop yield data, breeding research & seed IP', iconName: 'Sprout', badge: 'Proprietary' },
    { id: 'regulatory_ag', title: 'Regulatory / Compliance', description: 'Pesticide use records, USDA filings & food safety documentation', iconName: 'ShieldCheck' },
    { id: 'commodity_trading_ag', title: 'Commodity & Trading Data', description: 'Contract pricing & market position data', iconName: 'TrendingUp' },
    { id: 'low_public_ag', title: 'Low / Public', description: 'Public crop reports & community outreach materials', iconName: 'Globe' },
  ],
  nonprofit: [
    { id: 'donor_pii_np', title: 'Donor PII & Financials', description: 'Donor contact information, giving history & financial records', iconName: 'EyeOff', badge: 'Confidential' },
    { id: 'beneficiary_data_np', title: 'Beneficiary / Case Data', description: 'Client case files & service records', iconName: 'Lock' },
    { id: 'grant_compliance_np', title: 'Grant Compliance Data', description: 'Grant terms, Form 990 filings & funder reports', iconName: 'FileCheck' },
    { id: 'low_public_np', title: 'Low / Public', description: 'Newsletters & public campaign materials', iconName: 'Globe' },
  ],
  other: [
    { id: 'confidential_ip_other', title: 'Confidential / IP', description: 'Proprietary business information & strategic plans', iconName: 'Lock', badge: 'Confidential' },
    { id: 'customer_pii_other', title: 'Customer / Client PII', description: 'Client contact & account data', iconName: 'EyeOff' },
    { id: 'internal_other', title: 'Internal Only', description: 'Day-to-day operational data & internal memos', iconName: 'Building' },
    { id: 'low_public_other', title: 'Low / Public', description: 'Public marketing & published content', iconName: 'Globe' },
  ],
  default: [
...
export const ADAPTIVE_COLLABORATION: Record<string, QuizOptionTile[]> = {
  ...
  manufacturing: [
    { id: 'plant_floor_mfg', title: 'Plant Floor Teams', description: 'Shift supervisors, technicians & engineers on a single production floor', iconName: 'Factory' },
    { id: 'cross_plant_mfg', title: 'Cross-Plant / Multi-Site', description: 'Coordination across multiple manufacturing facilities', iconName: 'Network' },
    { id: 'supplier_facing_mfg', title: 'Supplier-Facing', description: 'Shared portals with suppliers & contract manufacturers', iconName: 'Truck' },
  ],
  education: [
    { id: 'classroom_dept_edu', title: 'Department / Classroom Level', description: 'Teachers & teaching assistants within a single department or grade level', iconName: 'BookOpen' },
    { id: 'institution_wide_edu', title: 'Institution-Wide', description: 'Cross-department collaboration across faculty senate & administration', iconName: 'Building' },
    { id: 'external_edu', title: 'External / Community-Facing', description: 'Parent communication, community partners & guest lecturers', iconName: 'Users' },
  ],
  government: [
    { id: 'agency_internal_gov', title: 'Agency Internal', description: 'A single department or bureau\'s internal operations', iconName: 'Building' },
    { id: 'interagency_gov', title: 'Interagency / Cross-Government', description: 'Collaboration across departments or levels of government', iconName: 'Network' },
    { id: 'public_facing_gov', title: 'Public-Facing', description: 'Citizen services, public comment portals & press interactions', iconName: 'Users' },
  ],
  legal: [
    { id: 'matter_team_legal', title: 'Matter Team Level', description: 'Attorneys & paralegals on a single case or deal, ethical walls apply', iconName: 'Gavel' },
    { id: 'firm_wide_legal', title: 'Firm-Wide', description: 'Cross-practice-group collaboration & knowledge sharing', iconName: 'Building2' },
    { id: 'client_facing_legal', title: 'Client-Facing / Opposing Counsel', description: 'Sharing drafts & filings with clients or external counsel', iconName: 'Users' },
  ],
  retail: [
    { id: 'store_team_retail', title: 'Store / Team Level', description: 'Individual store staff & shift coordination', iconName: 'Store' },
    { id: 'regional_retail', title: 'Regional / Multi-Store', description: 'District & regional management coordination', iconName: 'Network' },
    { id: 'vendor_customer_retail', title: 'Vendor & Customer-Facing', description: 'Supplier portals, customer service & loyalty communications', iconName: 'Users' },
  ],
  technology: [
    { id: 'team_squad_tech', title: 'Team / Squad Level', description: 'Engineering pods & sprint teams working within one codebase', iconName: 'Code' },
    { id: 'cross_org_tech', title: 'Cross-Org Engineering', description: 'Platform-wide collaboration across product lines', iconName: 'Network' },
    { id: 'customer_partner_tech', title: 'Customer & Partner-Facing', description: 'External API partners, customer support & documentation', iconName: 'Users' },
  ],
  energy: [
    { id: 'field_crew_energy', title: 'Field Crew Level', description: 'Site technicians & field engineers on a single asset', iconName: 'Zap' },
    { id: 'enterprise_energy', title: 'Enterprise-Wide', description: 'Cross-division coordination between generation, trading & operations', iconName: 'Network' },
    { id: 'regulator_partner_energy', title: 'Regulator & Partner-Facing', description: 'Sharing compliance data with regulators & joint-venture partners', iconName: 'Users' },
  ],
  transportation: [
    { id: 'dispatch_team_transport', title: 'Dispatch / Terminal Level', description: 'Local dispatch & terminal operations teams', iconName: 'Truck' },
    { id: 'network_wide_transport', title: 'Network-Wide', description: 'Cross-terminal & regional logistics coordination', iconName: 'Network' },
    { id: 'carrier_customer_transport', title: 'Carrier & Customer-Facing', description: 'Shared tracking portals with carriers & shippers', iconName: 'Users' },
  ],
  agriculture: [
    { id: 'farm_ops_ag', title: 'Farm Operations Level', description: 'Field crews & farm managers on a single operation', iconName: 'Sprout' },
    { id: 'cooperative_ag', title: 'Cooperative / Multi-Farm', description: 'Coordination across a co-op or multi-farm enterprise', iconName: 'Network' },
    { id: 'supply_chain_ag', title: 'Supply Chain-Facing', description: 'Shared data with distributors, buyers & processors', iconName: 'Truck' },
  ],
  nonprofit: [
    { id: 'program_team_np', title: 'Program Team Level', description: 'Case workers & program staff within one initiative', iconName: 'Heart' },
    { id: 'org_wide_np', title: 'Org-Wide', description: 'Cross-department collaboration across programs, development & finance', iconName: 'Building' },
    { id: 'donor_partner_np', title: 'Donor & Partner-Facing', description: 'Shared reporting with funders, partners & volunteers', iconName: 'Users' },
  ],
  other: [
    { id: 'team_level_other', title: 'Team Level', description: 'Immediate working team or department', iconName: 'Users' },
    { id: 'org_wide_other', title: 'Org-Wide', description: 'Broad cross-functional collaboration across the organization', iconName: 'Globe' },
    { id: 'external_other', title: 'External Partners & Vendors', description: 'Shared access with outside partners & vendors', iconName: 'Share2' },
  ],
  default: [
