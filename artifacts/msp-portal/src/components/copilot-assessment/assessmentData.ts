...
export const QUIZ_QUESTIONS: QuizQuestion[] = [
  {
    id: 1,
    question: "How is user identity and access management configured for high-privilege roles?",
    category: "Identity & Security",
    options: [
      { id: 'a', label: "Strict PIM & MFA Enabled", description: "All admin roles require Privileged Identity Management with time-bound approval and step-up MFA.", personaImpact: "High Executive Likelihood (+85%)", useCaseFit: "High Security Readiness" },
      { id: 'b', label: "Standard MFA Only", description: "Multi-factor authentication is required for all users, but permanent admin roles exist.", personaImpact: "Moderate Likelihood (+55%)", useCaseFit: "Requires PIM Configuration" },
      { id: 'c', label: "Legacy Basic Auth Present", description: "Some legacy protocols are enabled and conditional access rules are incomplete.", personaImpact: "Low Likelihood (+20%)", useCaseFit: "High Risk Blocker" },
      { id: 'd', label: "Unsure / Under Review", description: "Identity posture is currently being audited by external security vendors.", personaImpact: "Pending Verification", useCaseFit: "Audit Pending" }
    ]
  },
  {
    id: 2,
    question: "What is the current deployment state of Microsoft Purview Sensitivity Labels?",
    category: "Information Protection",
    options: [
      { id: 'a', label: "Fully Automated & Enforced", description: "Auto-labeling policies scan SharePoint, Teams, and Exchange continuously.", personaImpact: "Compliance Persona (+90%)", useCaseFit: "Automated Governance Active" },
      { id: 'b', label: "Manual User Selection", description: "Users are required to manually apply sensitivity labels when creating documents.", personaImpact: "Knowledge Worker (+70%)", useCaseFit: "Training Required" },
      { id: 'c', label: "Scoped to Top Secret Only", description: "Labels are applied only to highly classified financial and legal assets.", personaImpact: "Legal Persona (+60%)", useCaseFit: "Partial Coverage" },
      { id: 'd', label: "Not Yet Deployed", description: "No sensitivity labels or taxonomy implemented in tenant.", personaImpact: "Security Blocker Flagged", useCaseFit: "DLP Prerequisite Missing" }
    ]
  },
  {
    id: 3,
    question: "How are enterprise data loss prevention (DLP) policies configured?",
    category: "Compliance & Governance",
    options: [
      { id: 'a', label: "Strict Blocking & Overrides Audited", description: "DLP blocks external sharing of PII, financial, and IP data with strict logging.", personaImpact: "Security Lead (+95%)", useCaseFit: "Enterprise DLP Ready" },
      { id: 'b', label: "Warning Tooltips Only", description: "Users see warning tooltips when sharing sensitive information but can override freely.", personaImpact: "Sales & Ops (+75%)", useCaseFit: "Moderate Governance" },
      { id: 'c', label: "Minimal / Unmonitored", description: "Default tenant DLP settings with minimal custom rules.", personaImpact: "Risk Threshold Exceeded", useCaseFit: "Blocker for Copilot Agents" },
      { id: 'd', label: "Third-Party CASB Gateway", description: "Security relies on third-party proxy/CASB rather than native M365 DLP.", personaImpact: "IT Admin (+60%)", useCaseFit: "Integration Connector Needed" }
    ]
  },
  {
    id: 4,
    question: "What is your primary workforce operational archetype?",
    category: "Organization Profile",
    options: [
      { id: 'a', label: "Hybrid Knowledge Workers", description: "Heavy daily reliance on Teams, Word, PowerPoint, Excel, and Outlook.", personaImpact: "All Personas High (+90%)", useCaseFit: "M365 Copilot Core Fit" },
      { id: 'b', label: "Sales & Field Operations", description: "CRM-heavy workflows with high mobile and customer communication density.", personaImpact: "Sales Persona (+88%)", useCaseFit: "Copilot for Sales Fit" },
      { id: 'c', label: "Engineering & Technical Ops", description: "Code development, ticketing, architecture design, and automation heavy.", personaImpact: "Dev Persona (+85%)", useCaseFit: "GitHub & Azure Copilot Fit" },
      { id: 'd', label: "Customer Care & Support", description: "High ticket volume, call center, knowledge base searching, and triage.", personaImpact: "Service Persona (+92%)", useCaseFit: "Copilot for Service Fit" }
    ]
  },
  {
    id: 5,
    question: "What is the structure of your unstructured data repositories (SharePoint/OneDrive)?",
    category: "Data Hygiene & Architecture",
    options: [
      { id: 'a', label: "Clean Permissions & Lifecycle Rules", description: "Sites are pruned regularly, legacy permissions replaced with Microsoft 365 Groups.", personaImpact: "High Efficiency (+95%)", useCaseFit: "Zero Grounding Noise" },
      { id: 'b', label: "Over-Shared SharePoint Sites Present", description: "Broad 'Everyone except external' sharing links exist on legacy department sites.", personaImpact: "High Exposure Risk", useCaseFit: "Oversharing Remediation Req." },
      { id: 'c', label: "Siloed Repositories across Cloud Vendors", description: "Data split across Google Drive, Box, SharePoint, and local file shares.", personaImpact: "Partial Context (+50%)", useCaseFit: "Graph Connectors Needed" },
      { id: 'd', label: "Unstructured / Archive Heavy", description: "Decades of archived data without clear metadata or ownership.", personaImpact: "Relevance Noise Threat", useCaseFit: "Restricted Search Required" }
    ]
  },
  {
    id: 6,
    question: "What is your executive sponsorship and change management posture?",
    category: "Adoption & Change Management",
    options: [
      { id: 'a', label: "Dedicated Change Team & C-Suite Sponsor", description: "Formal champion network, metrics tracking, and mandatory enablement paths.", personaImpact: "Fast Value Realization", useCaseFit: "100% Rollout Readiness" },
      { id: 'b', label: "IT-Led Adoption Pilot", description: "IT department manages rollout with self-paced learning resources.", personaImpact: "Moderate Momentum (+65%)", useCaseFit: "Phased Pilot Fit" },
      { id: 'c', label: "Ad-hoc / User-Driven", description: "No structured change program; users expected to self-discover features.", personaImpact: "High Churn Risk", useCaseFit: "Champion Network Required" },
      { id: 'd', label: "Strict Regulatory Resistance", description: "Business units are hesitant due to audit and legal liability concerns.", personaImpact: "Governance First Needed", useCaseFit: "Sandbox Simulation Req." }
    ]
  },
  {
    id: 7,
    question: "Which Microsoft 365 licensing plan is currently assigned?",
    category: "Licensing & Infrastructure",
    options: [
      { id: 'a', label: "M365 E5 / A5 Enterprise", description: "Includes advanced security, compliance, analytics, and voice capabilities.", personaImpact: "Full Feature Access", useCaseFit: "Instant Licensing Add-on" },
      { id: 'b', label: "M365 E3 Enterprise", description: "Core enterprise productivity suite with add-on security packages.", personaImpact: "Standard Access", useCaseFit: "E5 Security Step-Up Rec." },
      { id: 'c', label: "Business Premium / Standard", description: "SMB licensing footprint with fundamental cloud services.", personaImpact: "SMB Persona Alignment", useCaseFit: "Seat Allocation Cap" },
      { id: 'd', label: "Mixed / Multi-Tenant Environment", description: "Multiple tenants with varied licensing profiles across subsidiaries.", personaImpact: "Multi-Tenant Complexity", useCaseFit: "Tenant Consolidation Plan" }
    ]
  },
  {
    id: 8,
    question: "What is the primary ROI driver expected by leadership?",
    category: "Business Impact & ROI",
    options: [
      { id: 'a', label: "Time Savings & Productivity (+5 hrs/wk)", description: "Automating routine document synthesis, email summaries, and meeting catch-ups.", personaImpact: "Executive & PM (+90%)", useCaseFit: "Productivity Model" },
      { id: 'b', label: "Process Acceleration & Time-to-Market", description: "Faster RFP responses, contract reviews, and code delivery cycles.", personaImpact: "Sales & Engineering (+92%)", useCaseFit: "Revenue Velocity Model" },
      { id: 'c', label: "Quality Uplift & Error Reduction", description: "Consistent analytical summaries, standardized compliance checks.", personaImpact: "Legal & Finance (+88%)", useCaseFit: "Quality Metrics Model" },
      { id: 'd', label: "Employee Satisfaction & Retention", description: "Reducing administrative cognitive burden and burnout.", personaImpact: "HR & Operations (+85%)", useCaseFit: "Employee Experience Model" }
    ]
  },
  {
    id: 9,
    question: "What level of custom AI extensibility (Copilot Studio / Plugins) is anticipated?",
    category: "Extensibility & Automation",
    options: [
      { id: 'a', label: "High Extensibility (Custom Agents + LOB APIs)", description: "Building custom declarative copilots connected to ERP/CRM via REST APIs.", personaImpact: "Technical Developer (+95%)", useCaseFit: "Copilot Studio Architecture" },
      { id: 'b', label: "Graph Connectors & Knowledge Bases", description: "Indexing external databases and knowledge articles into Microsoft Graph.", personaImpact: "Knowledge Manager (+80%)", useCaseFit: "Graph Connector Setup" },
      { id: 'c', label: "Out-of-the-Box M365 Apps Only", description: "Focusing solely on native Word, Excel, Teams, and Outlook capabilities.", personaImpact: "Standard User (+70%)", useCaseFit: "Zero Code Deployment" },
      { id: 'd', label: "Under Evaluation / Phase 2", description: "Extensibility planned only after initial 6-month core adoption.", personaImpact: "Future Extensibility", useCaseFit: "Phase 2 Roadmap Item" }
    ]
  },
  {
    id: 10,
    question: "What is your target timeline for enterprise-wide Copilot deployment?",
    category: "Deployment Velocity",
    options: [
      { id: 'a', label: "Immediate (0 - 30 Days)", description: "Fast-track wave deployment with pre-validated security guardrails.", personaImpact: "High Readiness Trigger", useCaseFit: "Express Onboarding" },
      { id: 'b', label: "Structured Wave (30 - 90 Days)", description: "Phased rollout across champion cohorts followed by business units.", personaImpact: "Balanced Velocity", useCaseFit: "Standard Enterprise Plan" },
      { id: 'c', label: "Fiscal Quarter Planning (90 - 180 Days)", description: "Aligning rollout with annual budget cycles and security remediation.", personaImpact: "Deep Prep Cohort", useCaseFit: "Remediation First" },
      { id: 'd', label: "Exploratory / Assessment Only", description: "Building business case and security matrix before purchasing licenses.", personaImpact: "Assessment Baseline", useCaseFit: "Business Case Stage" }
    ]
  }
];
