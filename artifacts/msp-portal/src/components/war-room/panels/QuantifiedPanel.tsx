 ...
 *
 * Source: warroom/project/M365 War Room.dc.html (template - gated on `showQuantified`)
...
export function QuantifiedPanel({ v }: { v: any }) {
  return (
    <>
    {" "}
    <div style={css(`position:absolute;bottom:calc(100% + 12px);right:0;width:min(330px,100%);z-index:51;border-radius:16px;padding:13px 15px;border:1px solid rgba(251,191,36,.3);background:linear-gradient(160deg,rgba(30,22,8,.72),rgba(2,6,23,.72));backdrop-filter:blur(14px);box-shadow:0 20px 54px rgba(2,6,23,.7),0 0 40px rgba(251,191,36,.12);animation:wr-rise 420ms cubic-bezier(.22,1,.36,1)`)}>
      {" "}
      <div style={css(`display:flex;align-items:center;gap:8px;margin-bottom:10px`)}>
        <span style={css(`flex:1;font-size:9.5px;font-weight:700;letter-spacing:.16em;text-transform:uppercase;color:#fbbf24`)}>
