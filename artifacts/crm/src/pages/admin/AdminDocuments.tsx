  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-lg font-bold text-[#0A2540]">Documents</h2>
      ...
      {showForm && (
        <div className="bg-[#F7F9FC] border border-border rounded-xl p-5 mb-6">
          ...
          <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-xs font-semibold text-[#0A2540] mb-1">Display Name <span className="text-muted-foreground font-normal">(optional — defaults to filename)</span></label>
              <input
                value={form.name}
            ...
            <div className="sm:col-span-2">
              ...
              <input
                type="file"
                accept=".pdf,.docx,.doc,.xlsx,.xls,.pptx,.ppt,.txt,.csv,.html,.htm,.zip"
                required
          ...
          {documents.map(doc => (
            <div key={doc.id} className="flex items-center gap-4 px-5 py-4">
              ...
              <button
                ...
                className="text-xs text-red-500 hover:text-red-700 font-semibold transition-colors flex-shrink-0"
              >
                Delete
              </button>
            </div>
