...
import { getJobStatus, getJobOutput, isTerminalStatus, isAzureConfigured } from "./azure-automation";
...
async function runInBackground(
  ...
  try {
    ...
    if (success) {
      ...
      // Always look for the next backlog run_workflow card in this client's
