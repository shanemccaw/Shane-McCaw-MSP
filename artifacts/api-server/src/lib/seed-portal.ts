...
export async function seedMarketingServices(): Promise<void> {
  ...
  const serviceAreas = [
    ...
    {
      slug: "service-area-retainer",
      name: "Fractional M365 Architect Retainer",
      serviceType: "service_area",
      billingType: "recurring_monthly" as const,
    ...
    },
    {
      ...
      serviceType: "service_area",
      billingType: "one_time" as const,
      tagline: "Modern intranets employees actually use.",
      description: "Expert information architecture, navigation design, and taxonomy that turns SharePoint into an intranet your team actually uses — not abandons.",
      badge: null,
      iconName: "Layout",
