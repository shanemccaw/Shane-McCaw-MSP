...
// is: unit-testable in isolation, and the one place both
// `routes/msp-standing-policies.ts` (activation) and
// `lib/policy-enactment.ts` (per-enactment CR raise) agree on the verdict.
