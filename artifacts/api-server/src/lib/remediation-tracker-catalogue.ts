...
export const REMEDIATION_TRACKER_CATALOGUE: readonly RemediationTrackerCatalogueStep[] = [
  { id: "s1", label: "Step 1", pillar: "governance", title: "Close org-wide sharing on the sensitive sites" },
  { id: "s2", label: "Step 2", pillar: "governance", title: "Export the remaining org-wide sites and route them to owners" },
  { id: "s3", label: "Step 3", pillar: "governance", title: "Expire all future anonymous links" },
  { id: "s4", label: "Step 4", pillar: "governance", title: "Revoke the existing anonymous links" },
  ...
  { id: "s7", label: "Step 7", pillar: "security", title: "Audit and fix MFA on the admin accounts" },
  { id: "s8", label: "Step 8", pillar: "security", title: "Scope a Conditional Access policy to privileged roles" },
  { id: "s9", label: "Step 9", pillar: "security", title: "Re-enable the disabled Conditional Access policy and remove its exclusion" },
  { id: "s10", label: "Step 10", pillar: "security", title: "Disable legacy authentication" },
  { id: "s11", label: "Step 11", pillar: "security", title: "Reduce standing Global Admins to break-glass accounts" },
  { id: "s12", label: "Step 12", pillar: "security", title: "Reinstate the disabled Safe Links policy" },
  ...
  { id: "s15", label: "Step 15", pillar: "compliance", title: "Auto-label regulated content instead of asking users individually" },
  { id: "s16", label: "Step 16", pillar: "compliance", title: "Extend DLP to Teams chat and OneDrive — in review mode" },
  { id: "s17", label: "Step 17", pillar: "compliance", title: "Extend retention to the uncovered workloads" },
  { id: "s18", label: "Step 18", pillar: "compliance", title: "Raise audit log retention above the 90-day floor" },
  { id: "s19", label: "Step 19", pillar: "licensing", title: "Identify dormant Copilot seats" },
  { id: "s20", label: "Step 20", pillar: "licensing", title: "Reclaim them after a 14-day notice" },
  { id: "s21", label: "Step 21", pillar: "licensing", title: "Reconcile mismatched SKU assignments" },
  { id: "s22", label: "Step 22", pillar: "licensing", title: "Move to group-based licensing and retire the legacy groups" },
  ...
  { id: "s28", label: "Step 28", pillar: "health", title: "Resolve OneDrive sync errors" },
  { id: "s29", label: "Step 29", pillar: "health", title: "Attest and dispose of inactive sites and orphaned channels" },
