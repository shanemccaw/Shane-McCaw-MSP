...
function mspToken(mspId: number, mspRole: typeof LEGACY_ROLE.mspOperator | typeof LEGACY_ROLE.mspAdmin | typeof LEGACY_ROLE.customer = LEGACY_ROLE.mspOperator, userId = 1): string {
  return jwt.sign(
