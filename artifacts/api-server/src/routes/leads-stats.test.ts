...
mock.module("@workspace/db", {
  namedExports: {
    ...
    // Remaining tables/values pulled in transitively via leads.ts's import
    // graph (workflow-engine, drift/config-diff, RBD, monitoring, etc.) —
    // not exercised by these leads-stats tests, sentinel stubs only.
