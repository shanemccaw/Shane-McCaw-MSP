  ...
  try {
    ...
    const tiers = rawTiers.map(t => {
      ...
      return {
        ...
        aiCreditAllowance: attrs.aiCreditAllowancePlatform ?? attrs.aiCreditAllowance ?? null,
      aiCreditAllowancePlatformValue: attrs.aiCreditAllowancePlatform ?? null,
      aiCreditAllowanceMspValue: attrs.aiCreditAllowanceMsp ?? null,
