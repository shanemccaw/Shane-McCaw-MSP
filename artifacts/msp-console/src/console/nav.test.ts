...
test("IA has 7 tenant groups and 23 ops pages", () => {
...
test("command palette lists root, every ops page, and tenant × page", () => {
  ...
  // 1 root + 23 ops + 4 tenants * 29 pages — see the IA counts test above for
  // how these totals are made up.
  assert.equal(cmds.length, 1 + 23 + customers.length * 29);
