...
import FreeScanAccount from "./marketing/pages/FreeScanAccount";
  ...
  return (
    <>
      ...
      <Switch>
        ...
        {/* Same reasoning (#4329): a paid Prospect's private, signed-in engagement page. */}
        <Route path="/scan/account" children={() => <FreeScanAccount />} />
