...
// Route /scan — recreated from Marketing Free Scan.dc.html.
...
export default function FreeScan() {
  return (
    <MarketingLayout current="none">
      {/* Part 2 — Marketing Free Scan.dc.html: real content replaces this PageStub. */}
      <PageStub title="Free Tenant Scan" route="/scan" />
    </MarketingLayout>
  );
}
