...
import {
  ...
  Package, Compass, LogIn, MessageCircle,
} from "lucide-react";
...
type DropdownName = "solutions" | "platform" | null;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-18">
          ...
          <nav className="hidden lg:flex items-center gap-1">
            ...
            <ChatCTA className={cn(navLinkClass(false), "flex items-center gap-1.5")} data-track="nav">
