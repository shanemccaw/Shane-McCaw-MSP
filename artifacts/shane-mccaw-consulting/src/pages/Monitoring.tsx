              ...
              <div className="flex flex-col items-center mb-10">
                ...
                <div className="flex items-center gap-3 flex-wrap justify-center">
                  <input
                    ...
                    onBlur={() => trackEvent("plan_compare", { label: `${seatCount} seats`, seats: seatCount, method: "custom_input" })}
                  ...
                  <div className="flex items-center gap-2">
                    {SEAT_PRESETS.map((preset) => (
                      <button
                        ...
                        onClick={() => {
                          setSeatCount(preset);
                          trackEvent("plan_compare", { label: `${preset} seats`, seats: preset, method: "preset" });
                        }}
                  ...
                  return (
                    ...
                    >
                      ...
                      <Link
                        ...
                        // checkout + server default to 1 seat and charge the floor-clamped
                        // 1-seat price instead of the real per-tenant price — the exact
                        // revenue bug Home.tsx's identical card already guards against.
                        href={`/checkout/${matched.slug}?seats=${seatCount}`}
