...
import {
  ...
  TrendingUp, Network, Star, Layers,
} from "lucide-react";
...
const config: QuizConfig = {
  ...
  tierUpsells: {
    Beginner: {
      ...
      description:
        "Your tenant has significant configuration gaps that need immediate attention. A structured architect-led audit identifies every issue — licensing waste, security misconfigurations, governance debt — and delivers a prioritised remediation roadmap.",
      ...
      <section className="pt-32 sm:pt-40 pb-16 px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="font-display text-4xl sm:text-5xl md:text-6xl font-bold text-text-primary tracking-tight leading-tight mb-6">
            Your M365 Tenant Is <GradientText>Growing.</GradientText>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {[
              ...
              {
                icon: Globe,
                title: "Defensible compliance documentation",
      ...
      <section className="border-t border-white/[0.06] py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <h2 className="font-display text-3xl md:text-4xl font-bold text-text-primary mb-4">
            Your M365 tenant health determines your security posture, your compliance position, and your <GradientText>Copilot readiness</GradientText>.
          </h2>
