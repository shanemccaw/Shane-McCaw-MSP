...
const config: QuizConfig = {
  ...
  categories: [
    { key: "identityAccess", label: "Identity & Access" },
    { key: "dataProtection", label: "Data Protection" },
    { key: "deviceManagement", label: "Device & Endpoint Management" },
    { key: "threatDetection", label: "Threat Detection & Response" },
    { key: "compliancePolicy", label: "Compliance & Policy" },
  ],
  fallbackQuestions: [
    "Is Multi-Factor Authentication (MFA) enforced for all users in your organisation — including admins, contractors, and shared accounts — or are there accounts still relying on username and password alone?",
    "Have you implemented Conditional Access policies in Entra ID to control which devices, locations, and conditions can access Microsoft 365 resources, or is access largely unrestricted once MFA is passed?",
    "Does your organisation use Microsoft Purview sensitivity labels or equivalent tools to classify and protect sensitive documents — for example, automatically encrypting confidential files or blocking sharing to external parties?",
    "Are Data Loss Prevention (DLP) policies configured in Microsoft 365 to detect and prevent the accidental or intentional exfiltration of sensitive data through email, Teams, SharePoint, or OneDrive?",
    "Are all devices used to access Microsoft 365 enrolled in Microsoft Intune or an equivalent Mobile Device Management (MDM) solution — with compliance policies, encryption, and remote wipe capability?",
    "How do you handle unmanaged or personal devices accessing Microsoft 365? Do you have App Protection Policies (MAM) in place, or can anyone access corporate data from any personal device without controls?",
    "Has your organisation reviewed your Microsoft Secure Score, and are there active efforts to implement the recommended security improvements it surfaces — or is the score largely ignored?",
    "Is Microsoft Defender for Office 365 configured and actively monitoring for phishing, malware, and business email compromise — with Safe Attachments, Safe Links, and anti-phishing policies enabled?",
    "What compliance frameworks is your organisation subject to — for example, HIPAA, CMMC, FedRAMP, SOX, GDPR — and have the relevant Microsoft Purview compliance controls been configured to support audit readiness?",
    "Has your organisation conducted a security incident response drill or tabletop exercise specific to Microsoft 365 — for example, simulating a compromised admin account or a mass phishing attack — in the last 12 months?",
  ],
  tierUpsells: {
    Beginner: {
