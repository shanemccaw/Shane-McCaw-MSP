              ...
              {RETAINERS.map((tier) => (
                <div
                  ...
                  className={`rounded-2xl p-6 flex flex-col gap-4 border ${
                    tier.highlight ? "bg-[#0A2540] border-[#0078D4]/40 shadow-xl" : "bg-[#F7F9FC] border-border"
                  }`}
                >
                  {tier.highlight && (
                  ...
                  <p className={`text-sm leading-relaxed flex-1 ${tier.highlight ? "text-white/70" : "text-muted-foreground"}`}>{tier.description}</p>
