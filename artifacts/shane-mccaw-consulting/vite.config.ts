...
// `previewPath = "/"`, `services.env.BASE_PATH = "/"`) — unlike its sibling
// front-ends, this one mounts at the root of its own origin, not a path prefix.
const SHANE_MCCAW_CONSULTING_CANONICAL_BASE = "/";
...
export default defineConfig(async ({ command }) => {
  ...
  const basePath = !rawBasePath
    ? SHANE_MCCAW_CONSULTING_CANONICAL_BASE
    : rawBasePath;
