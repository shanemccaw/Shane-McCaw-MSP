  ...
  "relative w-full rounded-lg border px-4 py-3 text-sm [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-foreground [&>svg~*]:pl-7",
  {
    variants: {
      variant: {
        ...
        warning:
          "border-status-amber/40 text-foreground bg-status-amber/5 [&>svg]:text-status-amber",
        info:
          "border-status-blue/40 text-foreground bg-status-blue/5 [&>svg]:text-status-blue",
      },
    },
    defaultVariants: {
      variant: "default",
