...
import { Tabs, TabsContent, TabsList, TabsTrigger } from "../components/ui/accordion"; // Swap or use local Shadcn tab primitive
...
export default function SimulatorStudioPage() {
  ...
  // Dense Control Canvas States shared downstream
