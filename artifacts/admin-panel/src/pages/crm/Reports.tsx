    ...
    <div className="p-4 sm:p-6 max-w-[1200px]">
      ...
      {showForm && (
        <div className="bg-accent border border-border rounded-xl p-5 mb-6">
          <h3 className="text-sm font-bold text-foreground mb-4">Upload Report</h3>
          <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-xs font-semibold text-foreground mb-1">Report Title *</label>
            ...
            <div>
              <label className="block text-xs font-semibold text-foreground mb-1">Report Date</label>
              <input type="date" value={form.reportDate} onChange={e => setForm(f => ({ ...f, reportDate: e.target.value }))}
                className="w-full border border-border rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-primary bg-accent text-foreground" />
            </div>
            <div className="sm:col-span-2">
              <label className="block text-xs font-semibold text-foreground mb-1">File (PDF or HTML) *</label>
      ...
      {loading ? (
        ...
        <div className="bg-card border border-border rounded-xl p-10 text-center text-muted-foreground text-sm">No reports yet.</div>
      ) : (
