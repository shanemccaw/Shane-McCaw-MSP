  ...
  return (
    <div className="p-6 max-w-[1200px]">
      <div className="flex items-center justify-between mb-6">
        <div>
          <h1 className="text-xl font-bold text-[#0A2540]">Documents</h1>
      ...
      {showForm && (
        <div className="bg-[#F7F9FC] border border-border rounded-xl p-5 mb-6">
          <h3 className="text-sm font-bold text-[#0A2540] mb-4">Upload Document to Project</h3>
          <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-semibold text-[#0A2540] mb-1">Project *</label>
            ...
            <div>
              <label className="block text-xs font-semibold text-[#0A2540] mb-1">Display Name <span className="text-muted-foreground font-normal">(optional)</span></label>
            ...
            <div className="sm:col-span-2">
              <label className="block text-xs font-semibold text-[#0A2540] mb-1">File *</label>
          ...
          {documents.map(doc => (
            <div key={doc.id} className="flex items-center gap-4 px-5 py-4">
              ...
              <button onClick={() => void handleDelete(doc.id)}
                className="text-xs text-red-500 hover:text-red-700 font-semibold transition-colors flex-shrink-0">Delete</button>
            </div>
          ))}
        </div>
      )}
