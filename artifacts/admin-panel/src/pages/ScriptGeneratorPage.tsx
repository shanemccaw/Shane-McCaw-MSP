  ...
  return (
    ...
    >
      ...
      <td className="px-4 py-3 hidden lg:table-cell" onClick={(e) => e.stopPropagation()}>
        {syncedAt ? (
          <div className="flex items-center gap-1.5">
            <span className="inline-flex items-center gap-1 text-[9px] font-medium px-2 py-0.5 rounded-full bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 whitespace-nowrap">
            ...
            <button
              ...
              title={`Re-sync to Azure (last: ${new Date(syncedAt).toLocaleString()})`}
            >
              {pushing
