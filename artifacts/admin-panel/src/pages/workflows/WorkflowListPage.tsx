...
const WF_TEMPLATES: Array<{ id: string; name: string; description: string; graph: { nodes: unknown[]; edges: unknown[] } }> = [
  {
    ...
    graph: {
      nodes: [
        ...
        { id: "nerr", type: "end",                 position: { x: 940, y: 400  }, data: { label: "Error", customerError: "SOW generation or signal evaluation failed — please retry or contact support." } },
      ],
      edges: [
        ...
        { id: "fe1", source: "n2",  target: "nerr", label: "failure", sourceHandle: "failure" },
        { id: "fe2", source: "n4",  target: "nerr", label: "failure", sourceHandle: "failure" },
        { id: "fe3", source: "n8",  target: "nerr", label: "failure", sourceHandle: "failure" },
        { id: "fe4", source: "n9",  target: "nerr", label: "failure", sourceHandle: "failure" },
      ],
    },
  },
];
