...
const WF_TEMPLATES: Array<{ id: string; name: string; description: string; graph: { nodes: unknown[]; edges: unknown[] } }> = [
  {
    ...
    graph: {
      ...
      edges: [
        ...
        { id: "fe2", source: "n4",  target: "nerr", label: "onError", sourceHandle: "onError" },
        { id: "fe3", source: "n8",  target: "nerr", label: "onError", sourceHandle: "onError" },
        { id: "fe4", source: "n9",  target: "nerr", label: "onError", sourceHandle: "onError" },
      ],
    },
  },
  {
