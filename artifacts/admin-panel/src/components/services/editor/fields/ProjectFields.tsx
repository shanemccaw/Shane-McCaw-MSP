...
const SECTIONS = PRODUCT_TYPE_CONFIGS.project.sections.filter(s => s.key !== "identity" && s.key !== "catalog");

export default function ProjectFields(props: FieldSectionsProps) {
