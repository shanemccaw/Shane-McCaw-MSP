...
const SECTIONS = PRODUCT_TYPE_CONFIGS.credit_pack.sections.filter(s => s.key !== "identity" && s.key !== "catalog");

export default function CreditPackFields(props: FieldSectionsProps) {
