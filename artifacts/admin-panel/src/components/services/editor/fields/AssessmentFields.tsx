...
const SECTIONS = PRODUCT_TYPE_CONFIGS.assessment.sections.filter(s => s.key !== "identity" && s.key !== "catalog");

export default function AssessmentFields(props: FieldSectionsProps) {
