 ...
 *
 * Seven fixed tabs, with Git and Run inside an amber capsule that marks them as
 * a developer set the way Office marks special tabs. The contextual tab, when
 * one is live, sits to the right behind a rule. The "Search everything" capsule
 * and the ribbon collapse chevron are pinned right.
 *
