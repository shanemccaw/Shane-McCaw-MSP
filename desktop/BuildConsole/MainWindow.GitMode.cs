...
namespace BuildConsole
{
    ...
    public partial class MainWindow
    {
        ...
        public void ExitGitMode()
        {
            ...
            ColSidebar.Width = _savedGitColSidebarWidth.Value > 0 ? _savedGitColSidebarWidth : new GridLength(0);
            ...
            ColQueue.Width = _savedGitColQueueWidth.Value > 0 ? _savedGitColQueueWidth : new GridLength(DefaultQueueWidth);
            UpdateColQueueWidth();
