...
- **`insights_generated_documents` reads, again** — this pack's §5/§6 read the same
  table the Documents pack (`docs/portal/documents-contract-pack.md` §2) and Customer Home
  pack (`docs/portal/customer-home-and-timeline-contract-pack.md` §1) already document, each
