...
**This is a different surface from `docs/portal/team-management-and-invitations-contract-pack.md`,
...
pair (`docs/portal/offboarding-contract-pack.md` vs `docs/msp-console/offboarding-msp-console-contract-pack.md`)
already established.
...
- `docs/portal/team-management-and-invitations-contract-pack.md` — the Portal pack, cited for the
