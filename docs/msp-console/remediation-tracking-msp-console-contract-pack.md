...
This is a **separate module** from `docs/portal/remediation-tracking-contract-pack.md` (the
...
(`docs/portal/remediation-tracking-contract-pack.md` §1a) with one addition the customer pack's own
...
`docs/msp-console/risk-register-msp-console-contract-pack.md` §7.3 uses for a comparably minor gap) — noted so
...
`docs/portal/remediation-tracking-contract-pack.md` (§1a's `WireTrackerStep`, §2's CURRENT/DECIDED
...
`docs/portal/microsoft-changes-contract-pack.md`'s own replacement issue (its dispatch history) exists
