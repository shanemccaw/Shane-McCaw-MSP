...
This is a **separate module** from `docs/portal/offers-and-sow-acceptance-contract-pack.md` (#2448, the
...
- **The customer-portal pack's own §1** (`docs/portal/offers-and-sow-acceptance-contract-pack.md`) states
