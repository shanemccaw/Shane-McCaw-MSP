...
`/api/admin/webhooks/*`), already fully extracted in `docs/portal/webhooks-contract-pack.md` (#1597). That
...
(`docs/portal/webhooks-contract-pack.md` §6) protects deliveries with, mirrored for the inbound direction.
...
`docs/portal/webhooks-contract-pack.md` §4) is for outbound webhook subscriptions.
...
- **No relationship to `outbound_webhooks`/`outbound_webhook_deliveries`** (the table pair
  `docs/portal/webhooks-contract-pack.md` documents) — confirmed by search, this file does not import
