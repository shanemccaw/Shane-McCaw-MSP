...
**This is a different surface from `docs/portal/data-rights-and-privacy-contract-pack.md`, not a
...
for that reason — matching the same state `docs/msp-console/sops-msp-console-contract-pack.md` (#2595)
...
(`docs/portal/data-rights-and-privacy-contract-pack.md:111-146`) — repeated here only at the level
...
- **`audit_logs.action_type`** — plain `text`, no DB enum constraint. This surface's own
  ...
  `docs/portal/data-rights-and-privacy-contract-pack.md:180-185`.
...
Restated from the portal-side pack (`docs/portal/data-rights-and-privacy-contract-pack.md:213-243`)
...
- The customer-facing `GET /api/portal/data-export` / `POST /api/portal/deletion-request`
  field-by-field extraction — fully covered by `docs/portal/data-rights-and-privacy-contract-pack.md`
