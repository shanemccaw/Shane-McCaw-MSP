...
(`webhooks.ts`, extracted at `docs/portal/webhooks-contract-pack.md`, #1597) already writes.

**This pack replaces `docs/msp-console/msp-webhooks-inbound-contract-pack.md` (#2610) for this Feature.** That
...
**This pack covers B only.** A is already fully extracted at `docs/portal/webhooks-contract-pack.md`
...
`docs/portal/webhooks-contract-pack.md §6`), and B's disable action doesn't touch it either.
...
subscribable but has no dispatch call site anywhere** (`docs/portal/webhooks-contract-pack.md §4(A)`, restated
...
(`docs/portal/webhooks-contract-pack.md`) currently surfaces it to the owner. Real product decision for
