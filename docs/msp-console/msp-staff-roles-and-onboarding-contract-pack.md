...
`docs/msp-console/offboarding-msp-console-contract-pack.md` §0 and `docs/msp-console/sops-msp-console-contract-pack.md`
...
same reasoning `docs/msp-console/offboarding-msp-console-contract-pack.md` §0.1 already used for its
own Feature.
...
- **MSP status gate on invite accept** — reuses `msps.status: "active" | "suspended" |
  "trial"` (same enum documented in `docs/msp-console/offboarding-msp-console-contract-pack.md` §5).
