...
**This is a different surface from `docs/portal/offboarding-contract-pack.md`, not a re-run of
...
`docs/msp-console/sops-msp-console-contract-pack.md` vs `docs/portal/sops-contract-pack.md`.
...
- `GET /api/msp/dashboard` — `msp-portal.ts:127-373`, `msp.offboardingState` /
  ...
  `docs/portal/offboarding-contract-pack.md` §1 already drew).
...
is the same expected pre-scaffolding state `docs/msp-console/sops-msp-console-contract-pack.md` §0
...
this MSP-console-scoped surface existed — `docs/portal/offboarding-contract-pack.md`, part of
