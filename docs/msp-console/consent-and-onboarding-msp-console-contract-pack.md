...
This is a **separate module** from `docs/portal/consent-and-onboarding-contract-pack.md` (the
...
pre-Design/pre-wire state, same threshold the sibling `docs/msp-console/risk-register-msp-console-contract-pack.md`
...
`docs/portal/consent-and-onboarding-contract-pack.md` §1b already documents as the real source of truth
...
| Onboarding link → service | `msp_onboarding_links.serviceId` | `services.id`, no FK | Raw id only, §2 | No hard FK — same no-FK addressing convention `docs/portal/consent-and-onboarding-contract-pack.md` §6a documents for the same column, read from the other side |
...
(`docs/portal/consent-and-onboarding-contract-pack.md`, #2758) and the sibling MSP-console pack
(`docs/msp-console/risk-register-msp-console-contract-pack.md`, #2580) for format and cross-tier comparison.
