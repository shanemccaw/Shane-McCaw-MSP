...
- `artifacts/api-server/src/index.ts:981-1109` — `sla_policies` / `sla_timers` / `sla_breaches`
  ...
  raw `db.execute(sql...)`, same pattern §4 of `docs/portal/scope-and-sla-contract-pack.md` already
...
**Distinct from, and not a re-run of, `docs/portal/scope-and-sla-contract-pack.md`** — that pack (from
...
- **Customer-facing counterpart**: `docs/portal/scope-and-sla-contract-pack.md` (#2452) — the read-only
