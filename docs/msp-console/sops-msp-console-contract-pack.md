...
**This is a different surface from `docs/portal/sops-contract-pack.md`, not a re-run of it.**
...
5. **`get_running_sops` (mcp-server) is the one real, live consumer of this surface today**
   ...
   (`docs/msp-console/sops-msp-console-contract-pack.md`'s own §0.1 table cites the file directly).
...
this MSP-console-scoped surface existed — the existing `docs/portal/sops-contract-pack.md`,
