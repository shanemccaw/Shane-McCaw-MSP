...
**This is a different surface from `docs/portal/runbooks-contract-pack.md`, not a re-run of
...
the sibling SOPs-MSP-console pack (`docs/msp-console/sops-msp-console-contract-pack.md`, extracted
...
route's own shape (`docs/portal/runbooks-contract-pack.md` §1.1–§1.9), because both surfaces
...
extraction of them. Cross-checked against `docs/portal/runbooks-contract-pack.md`
