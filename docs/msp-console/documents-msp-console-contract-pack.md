...
**This is a different surface from `docs/portal/documents-contract-pack.md`, not a re-run of
...
2. **An aggregated read/share view over documents the *platform already generated for
   ...
   `docs/portal/documents-contract-pack.md` already documents, read-only here except for its
...
`docs/portal/documents-contract-pack.md`, cited here only far enough to be honest about
...
Unlike the sibling `docs/msp-console/offboarding-msp-console-contract-pack.md` (backed by
...
`docs/msp-console/offboarding-msp-console-contract-pack.md`'s header already carries.
...
(`docs/portal/documents-contract-pack.md`) is gated to `doc.customerId === caller's own
...
pre-scaffolding state `docs/msp-console/offboarding-msp-console-contract-pack.md` §0 and
`docs/msp-console/sops-msp-console-contract-pack.md` §0 already documented for their own
...
`docs/portal/documents-contract-pack.md`'s customer-side `POST /portal/documents/:id/share`
...
already-documented pre-scaffolding gap `docs/portal/documents-contract-pack.md` covers for its
...
- **`insights_generated_documents` is shared, read-only ground with
  `docs/portal/documents-contract-pack.md`.** §2's entire hub is a second, MSP-staff-scoped
...
this MSP-console-scoped Documents surface existed — `docs/portal/documents-contract-pack.md`,
