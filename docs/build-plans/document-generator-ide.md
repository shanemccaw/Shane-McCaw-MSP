...
|-------|-------|--------|-------|
| 1 | Document Generator admin page — list, generate, preview, history | Not Started | #TBD |
| 2 | Retire legacy insights generation UI — remove nav entry, mark files dead | Not Started | #TBD |
