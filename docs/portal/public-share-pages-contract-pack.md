...
**already fully documented** in `docs/portal/documents-contract-pack.md` §2c–2e, under the
...
- `docs/portal/documents-contract-pack.md` §2c–2e — cited, not re-derived, for §1

---

## 1. Wire contract — `GET /api/public/documents/:shareToken` (condensed; full contract in `docs/portal/documents-contract-pack.md` §2c–2e)
...
`docs/portal/documents-contract-pack.md` §2e for the exact field — not re-derived here).
...
- **`GET /api/public/documents/:shareToken`**: no "genuinely empty" state — a missing or
  expired token is 404/410, not an empty body (see `docs/portal/documents-contract-pack.md`
...
- **`docs/portal/documents-contract-pack.md` §2c–2e** — same two `public/documents` routes,
  already fully documented there under the Documents Feature; §1 above cross-references
  rather than duplicates.
- **`docs/portal/offers-and-sow-acceptance-contract-pack.md`** — that pack's §5–§7 document the
...
- **`insights_generated_documents`** — §1's `public/documents/:shareToken` reads this
  ...
  `docs/portal/documents-contract-pack.md` and `docs/portal/customer-home-and-timeline-contract-pack.md`
