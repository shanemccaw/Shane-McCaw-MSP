...
honestly documented without their siblings (same discipline as `docs/portal/offboarding-contract-pack.md`):
...
- **Diagnostic finding source** — `mspDiagnosticFindingsTable.findingSource`
  ...
  (`docs/portal/microsoft-changes-contract-pack.md`/policy-decisions own that vocabulary).
...
field scope — see `docs/portal/shanebot-contract-pack.md` for that engine's own documentation.
