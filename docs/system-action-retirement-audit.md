...
| 3 | Declined-consent dedicated error-state UI | ✅ BUILT | `artifacts/portal/src/pages/consent-declined.tsx:25` (path corrected from `artifacts/msp-portal`, retired for `artifacts/portal` at `f40438cdc`; NOT carried over — this file does not exist in `artifacts/portal`) — `ConsentDeclinedPage`; registered at `App.tsx:517` at route `/consent/declined`; covered by `consent.test.ts:289` |
| 4 | MSP-facing performance dashboard | ✅ BUILT | `artifacts/api-server/src/routes/msp-portal.ts:37` — `GET /api/msp/dashboard` with KPIs + growth widgets; `artifacts/portal/src/pages/dashboard.tsx:133` (path corrected from `artifacts/msp-portal`, retired for `artifacts/portal` at `f40438cdc`; NOT carried over — this file does not exist in `artifacts/portal`); covered by `msp-portal.test.ts:126` |
