...
derived from #1595" — i.e. the write-side mirror of `docs/account-security-contract-pack.md`
...
MSP-staff-roster management in `docs/msp-staff-roles-and-onboarding-contract-pack.md` §4**,
...
from also carrying `mspId`. Confirmed live (`docs/msp-staff-roles-and-onboarding-contract-pack.md`
...
- **This pack's five routes and `docs/msp-staff-roles-and-onboarding-contract-pack.md` §4
...
- **`docs/account-security-contract-pack.md`** (portal's own customer-facing read side, per
...
`docs/msp-staff-roles-and-onboarding-contract-pack.md` (§4, §7, §8) to identify genuine
